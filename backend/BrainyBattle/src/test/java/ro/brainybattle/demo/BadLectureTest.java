...
public class BadLectureTest {
    @Autowired
    private TestRestTemplate restTemplate;
    @LocalServerPort
    private int port;
    @Test
    void testareLectureInexistent() throws Exception{
        String token="";
        ...
        ResponseEntity<String> response1=new TestRestTemplate().exchange("http://localhost:" + port + "/lecture/NumeRandomInexistent", HttpMethod.GET,new HttpEntity<Object>(headers),String.class);
