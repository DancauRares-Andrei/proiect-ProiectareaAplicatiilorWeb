...
public class GoodChatTest {
    @Autowired
    private TestRestTemplate restTemplate;
    @LocalServerPort
    private int port;
    @Test
    void testareChatUserAutentificat() throws Exception{
        String token="";
        ...
        ResponseEntity<String> response1=new TestRestTemplate().exchange("http://localhost:" + port + "/chat", HttpMethod.GET,new HttpEntity<Object>(headers),String.class);
