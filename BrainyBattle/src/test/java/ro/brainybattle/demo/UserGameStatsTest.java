...
public class UserGameStatsTest {
    @Autowired
    private TestRestTemplate restTemplate;
    @LocalServerPort
    private int port;
    @Test
    void testareStatsExistent() throws Exception{
        String token="";
        ...
        ResponseEntity<String> response1=new TestRestTemplate().exchange("http://localhost:" + port + "/details", HttpMethod.GET,new HttpEntity<Object>(headers),String.class);
